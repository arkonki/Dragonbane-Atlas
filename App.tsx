  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-200 font-sans selection:bg-emerald-900 selection:text-emerald-100 relative overflow-x-hidden">
      ...
      <div className={`transition-all duration-700 relative z-10 ${view === AppView.VIEWER ? 'opacity-0 scale-95 pointer-events-none fixed' : 'opacity-100 scale-100'}`}>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-5 md:gap-8">
              ...
              <div className="flex items-center gap-3 sm:gap-5 w-full md:w-auto justify-center md:justify-start">
                <div className="relative group">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-stone-900 border-2 border-emerald-800/50 rounded-xl flex items-center justify-center transform rotate-3 group-hover:rotate-0 transition-all duration-500 shadow-inner">
                    <Skull className="w-7 h-7 sm:w-8 sm:h-8 text-emerald-500 group-hover:scale-110 transition-transform" />
                  </div>
                </div>
                <div>
                  <h1 className="text-2xl sm:text-3xl font-display font-black tracking-[0.08em] sm:tracking-[0.2em] text-white uppercase drop-shadow-md">
              ...
              <div className="relative w-full md:w-[420px] group">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-2.5 sm:py-3 border border-stone-800/50 rounded-full leading-5 bg-stone-950/50 text-stone-200 placeholder-stone-600 focus:outline-none focus:bg-stone-900 focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30 text-sm transition-all shadow-inner"
                />
              </div>
            </div>
          </div>
        ...
        <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            {[
              ...
              <div key={i} className="bg-stone-900/40 border border-stone-800/50 rounded-lg p-4 sm:p-5 backdrop-blur-sm flex flex-col gap-2 items-center md:items-start group hover:bg-stone-800/60 transition-all duration-300">
          ...
          <section className="pb-12 sm:pb-20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-lg sm:text-xl font-display font-bold text-stone-100 uppercase tracking-wide sm:tracking-widest">Historical Archives {maps.length > 0 && `(${maps.length})`}</h2>
              </div>

              <div className="hidden md:flex items-center gap-2 text-xs font-mono text-stone-500 uppercase">
        ...
        {/* Footer */}
        <footer className="border-t border-stone-900/40 pt-8 sm:pt-12 pb-7 sm:pb-10 text-center relative opacity-50 hover:opacity-100 transition-opacity">
